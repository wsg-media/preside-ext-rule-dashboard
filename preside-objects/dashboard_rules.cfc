...
component output=false datamanagerGridFields="label,crontab_definition,enabled,last_ran,next_run"{
	...
	property name="filter_condition" relationship="many-to-one" relatedto="rules_engine_condition"  required=false control="filterPicker";
}
